package com.isaccanedo.login.service

import com.isaccanedo.login.repository.RoleRepository
import com.isaccanedo.login.repository.UserRepository
...
class UserServiceGroovyTest extends Specification {
    ...
    def "Find User By Email"() {
        ...
        userRepository.findByEmail("test@test.com") >> com.isaccanedo.login.model.User.builder()
                .id(1)
                .email("test@test.com")
                .build()
